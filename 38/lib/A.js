...
~(function(window){
    ...
    A.fn = A.prototype ={
        ...
        init: function (selector, context) {
            ...
            // 如果是id选择器 当indexOf返回值为-1 表示没有查找到目标字符串 而-1为真值 所以要处理一下使用按位非(~)操作处理 加1取负
            if(~selector.indexOf('#')){
    ...
    A.fn.extend({
        ...
        hasClass: function (val) {
            ...
            // 如果获取到的第一个元素类名包含val 则返回true, 否则返回false
